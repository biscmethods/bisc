...
matequal_2 <- function(x, y, tol = 1e-5) {
...
loglikelihood_calc_matrix_2 <- function(dat,
                                        models,
                                        target_genes_residual_var,
                                        penalization_lambda,
                                        n_cell_clusters,
...
biclust_2 <- function(dat = dat,
  ...
  for (i_main in 1:max_iter) {
    ...
    # start.time <- Sys.time()
    # likelihood <- loglikelihood_calc_matrix_2(dat,
    #                                                models,
    #                                                target_genes_residual_var,
    #                                                penalization_lambda,
    #                                                n_cell_clusters,
    ...
    #
    # matequal_2(likelihood, likelihood_matrix)
    print(likelihood)
    likelihood[is.nan(likelihood)] <- .Machine$double.eps
    ...
    likelihood <- plotrix::rescale(likelihood, c(0, 1))
    weigths <- likelihood
