...
if (!file.exists(file.path(data_path, "bisc_results_list.rds")) | redo_flag) {
  ...
  saveRDS(bisc_results_list, file.path(data_path, "bisc_results_list.rds"))
} else {
  bisc_results_list    <- readRDS(file.path(data_path, "bisc_results_list.rds"))
}
