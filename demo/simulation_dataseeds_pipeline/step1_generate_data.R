...
if (!file.exists(file.path(data_path, "sim_data.rds")) | redo_flag) {
  ...
  saveRDS(
    scenarios,
    file.path(data_path, "sim_data.rds")
  )

} else {


  scenarios <- readRDS(file.path(data_path, "sim_data.rds"))
