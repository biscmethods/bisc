...
for (i_cell_cluster in seq(n_cell_clusters)) {
  ...
  saveRDS(results, file.path(path_data, paste0("scregResults_pbmc_lambda_", paste0(penalization_lambda, collapse = "-"),
  ...
  saveRDS(outputs, file.path(path_data, paste0("scregResults_pbmc_lambda_printOutput_", paste0(penalization_lambda, collapse = "-"),
                                               "_cellCluster_", i_cell_cluster,
                                               "_nRegulatorGenes_", n_regulator_genes,
                                               "_nTargetGenes_", n_target_genes,
                                               "_nCells_", ncol(current_cell_cluster),
