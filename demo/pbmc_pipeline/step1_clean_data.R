...
path_dataset <- file.path(path_data, "pbmc_granulocyte_sorted_3k_filtered_feature_bc_matrix.h5")
path_env_data <- file.path(path_data, "env_data_pbmc_sctransform.RData")
path_general_env_data <- file.path(path_data, "env_data_general_pbmc_sctransform.RData")
path_gex <- file.path(path_data, "GEX Graph-Based.csv")
