  ...
  # Example usage
  stats2table(tibble = cell_data,    outfile = 'cell_data_runseeds.tex',    caption = 'Rand Indexes on cell cluster allocation')
  stats2table(tibble = gene_data,    outfile = 'gene_data_runseeds.tex',    caption = 'Rand Indexes on gene module allocation')
  stats2table(tibble = biclust_data, outfile = 'biclust_data_runseeds.tex', caption = 'Rand Indexes on bicluster allocation')
