...
if (!file.exists(file.path(output_path, "sim_test_data.rds")) |
    redo_flag) {
  ...
  scenarios_test <- create_scenario(scenario_list = scenarios_test ,
                               description = "Simple",
                               n_cell_clusters = 2,
                               n_target_gene_clusters = c(4, 2),  # Number of target gene clusters in each cell cluster
                               n_target_genes = 100,
  ...
  saveRDS(
    scenarios_test,
    file.path(output_path, "sim_test_data.rds")
  )

} else {


  scenarios_test <- readRDS(file.path(output_path, "sim_test_data.rds"))
